...
```mermaid
graph LR
  FR-001[FR-001 Deposit] --> FR-005[FR-005 Mint shares]
  FR-002[FR-002 Withdraw] -. implicit .-> FR-001
  FR-007[FR-007 Claim] -. implicit .-> FR-005
```
...
- **Implicit dependencies not stated**:
  - FR-002 implies FR-001 (withdraw requires prior deposit) — not stated explicitly.
