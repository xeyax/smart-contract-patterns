...
- **Item A**: FR-001 — "Users can deposit anytime"
- **Item B**: FR-008 — "Deposits blocked when paused"
- **Conflict**: FR-001's "anytime" excludes the Paused state, contradicting FR-008's restriction.
- **Suggested resolution**: qualify FR-001 to "anytime in Normal state", or merge the paused-state exception from FR-008 into FR-001.
