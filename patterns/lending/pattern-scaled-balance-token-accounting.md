...
- BendDAO bTokens and debt tokens mint and burn scaled balances against reserve liquidity and variable-borrow indexes, while balance views multiply by normalized income or debt in `/private/tmp/defillama-source/BendDAO__bend-lending-protocol/contracts/protocol/BToken.sol` and `/private/tmp/defillama-source/BendDAO__bend-lending-protocol/contracts/protocol/DebtToken.sol`.
