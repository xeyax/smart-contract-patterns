...
- Orca Whirlpools bounds swap steps to the next initialized tick or price limit in [`programs/whirlpool/src/manager/swap_manager.rs`](https://github.com/orca-so/whirlpools/blob/a119d79bada4e730fef791cac6adb669405a21de/programs/whirlpool/src/manager/swap_manager.rs), while tick crossing and liquidity updates maintain range accounting in `tick_manager.rs` and `liquidity_manager.rs`.
