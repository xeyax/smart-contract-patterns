...
- Yearn V3 mints vault-owned locked shares on profit or refund reports, offsets fees and losses against locked shares, uses weighted-average unlock rollover, and allows the profit unlock manager to set unlock time to zero in [`contracts/VaultV3.vy`](https://github.com/yearn/yearn-vaults-v3/blob/104a2b233bc6d43ba40720d68355b04d2dc31795/contracts/VaultV3.vy).
- Yearn V3 tests profit staying out of PPS until unlock and immediate unlock when max unlock time is set to zero in [`tests/unit/vault/test_profit_unlocking.py`](https://github.com/yearn/yearn-vaults-v3/blob/104a2b233bc6d43ba40720d68355b04d2dc31795/tests/unit/vault/test_profit_unlocking.py).
- Avant `StakedAvUSD` excludes unvested rewards from `totalAssets()` and vests them over an 8-hour window, with tests around share pricing and delayed reward vesting in [`contracts/StakedAvUSD.sol`](https://github.com/Avant-Protocol/avUSD-Contracts/blob/43858abc5a3c481e3b2d02790d168b88e630e7b1/contracts/StakedAvUSD.sol).
- Euler Savings Rate smears direct asset donations through `gulf` and `interestLeft`, with tests for repeated donations, partial accrual, and zero remaining interest in [`src/Synths/EulerSavingsRate.sol`](https://github.com/euler-xyz/euler-vault-kit/blob/5b98b42048ba11ae82fb62dfec06d1010c8e41e6/src/Synths/EulerSavingsRate.sol) and `test/unit/esr/ESR.Gulp.t.sol`.
- Sanctum INF releases withheld yield over time, absorbs losses against withheld yield and protocol-fee buckets before LP-due value, and uses release-rate tests in [`controller/core/src/yields/update.rs`](https://github.com/igneous-labs/inf-1.5/blob/29dbbd47e822e5e3fbcc5a2e2190f00dd4e075be/controller/core/src/yields/update.rs), `controller/core/src/yields/release.rs`, and `controller/core/src/typedefs/rps.rs`.
- Origin Dollar vaults rate-limit rebases and drip yield through vault and harvester state in [`contracts/contracts/vault/VaultStorage.sol`](https://github.com/originprotocol/origin-dollar/blob/cd7218c2b070a52470b2621c3ce0ce12378ba700/contracts/contracts/vault/VaultStorage.sol), [`contracts/contracts/vault/VaultCore.sol`](https://github.com/originprotocol/origin-dollar/blob/cd7218c2b070a52470b2621c3ce0ce12378ba700/contracts/contracts/vault/VaultCore.sol), and [`contracts/contracts/harvest/Dripper.sol`](https://github.com/originprotocol/origin-dollar/blob/cd7218c2b070a52470b2621c3ce0ce12378ba700/contracts/contracts/harvest/Dripper.sol).
- mStable SavingsManager collects platform interest on a cadence, validates APY, carries leftover unstreamed rewards, and streams interest or liquidation proceeds over fixed windows in [`contracts/savings/SavingsManager.sol`](https://github.com/mstable/mStable-contracts/blob/51da0272104d207abcbecb5dd545fec2e6abbfe9/contracts/savings/SavingsManager.sol).
